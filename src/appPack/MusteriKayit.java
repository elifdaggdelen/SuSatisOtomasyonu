...
public class MusteriKayit extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        mAdi=jTextField1.getText().trim();
        mSoyadi=jTextField2.getText().trim();
        mTel=jTextField3.getText().trim();
        mAdres=jTextField4.getText().trim();
        String insert = "INSERT INTO `customers` VALUES (NULL, '"+mAdi+"', '"+mSoyadi+"', '"+mTel+"', '"+mAdres+"')";
        //insert statement
        DB db = new DB();
        try {
